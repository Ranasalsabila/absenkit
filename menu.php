...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  <div class="container">
	<div class="navbar-header">
	  ...
	  <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-fire"></span>ABSENSI SISWA</a>
	</div>
	<div class="navbar-collapse collapse">
	  <ul class="nav navbar-nav">
		<li class="active"><a href="./admin.php">Home</a></li>
		<li><a href="./admin.php?hlm=bayar">Absensi</a></li>
		<li class="dropdown">
		  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Laporan <b class="caret"></b></a>
		  <ul class="dropdown-menu">
			<li><a href="./admin.php?hlm=laporan">Rekap Absensi</a></li>
			<li><a href="./admin.php?hlm=laporan&sub=tagihan">Cetak Absensi</a></li>
		  </ul>
		</li>
		<li class="dropdown">
		  ...
		  <ul class="dropdown-menu">
			...
			?>
			<li class="divider"></li>
			<li><a href="./admin.php?hlm=master&sub=jenis">Jenis Absensi</a></li>
